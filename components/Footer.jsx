...
export default function Footer() {
  ...
  return (
    ...
    <div className="space-y-10 bg-gradient-to-r from-dark-blue to-blue-500 px-6 pb-10 pt-8 text-white md:px-10 md:pt-20">
      ...
      <div className="flex items-center justify-between space-x-4 border-t border-white border-opacity-30 pt-10 md:space-x-0">
        <div className="text-xs">
          Ace Strategy and Consult Limited 2023 &copy; All rights reserved.
        </div>
