      ...
      <div className="grid md:grid-cols-2 pb-16">
        ...
        >
          <Carousel.Slide
            ...
            style={{
              backgroundImage: `url("https://res.cloudinary.com/daojlqwdo/image/upload/v1692881706/ace/289d8fa2ca_qwtvwg.jpg")`,
            }}
          ></Carousel.Slide>
          ...
          <Carousel.Slide
            className="bg-cover bg-center h-[33rem]"
            style={{
              backgroundImage: `url("https://res.cloudinary.com/daojlqwdo/image/upload/v1692881713/ace/67c27359e1_zdijca.jpg")`,
            }}
          ></Carousel.Slide>
                ...
                <div className="md:grid grid-cols-2 space-y-4 md:space-y-0 border-4 border-blue-800 p-16">
                  ...
                  <div className="md:-mr-80 place-self-center bg-black">
                    <div
                      className="w-[28rem] h-[18rem] bg-center bg-cover bg-no-repeat hidden md:block"
                      style={{
                        backgroundImage: `url("https://images.pexels.com/photos/8553867/pexels-photo-8553867.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2")`,
                      }}
                      alt=""
                    ></div>
                    ...
                    <img
                      className="w-[28rem] md:hidden block"
                      src="https://images.pexels.com/photos/8553867/pexels-photo-8553867.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="md:grid grid-cols-2 space-y-4 md:space-y-0 border-4 border-blue-800 p-16">
                  ...
                  <div className="md:-mr-80 place-self-center bg-black">
                    <div
                      ...
                      style={{
                        backgroundImage: `url("https://images.pexels.com/photos/8555530/pexels-photo-8555530.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2")`,
                      }}
                      alt=""
                    ></div>
                    ...
                    <img
                      className="w-[28rem] md:hidden block"
                      src="https://images.pexels.com/photos/8555530/pexels-photo-8555530.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                      alt=""
                    />
                  </div>
                </div>
      ...
      <div className="grid gap-10 bg-gradient-to-r from-dark-blue to-blue-500 px-6 py-10 md:grid-cols-5 md:gap-20 md:px-10 md:py-32">
        ...
        <div className="col-span-4 grid gap-10 md:grid-cols-3">
          ...
          <div className="space-y-6 bg-gray-200 p-6 md:p-10">
            ...
            <div className="text-gray-700">
              We support organizations to continually assess, learn from, and
          ...
          <div className="space-y-6 bg-gray-200 p-6 md:p-10">
            <div className="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="fill-current text-gray-700 w-7"
            ...
            <div className="text-2xl font-medium text-dark-blue">Research</div>

            <div className="text-gray-700">
              We conduct rigorous research and analysis of data to inform
              scientifically resilient decisions.
            </div>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              ...
              <div className="space-y-6 bg-gray-200 p-6 md:p-10">
                ...
                <div
                  ...
                  className="inline-flex cursor-pointer bg-black px-4 py-2 text-sm font-semibold uppercase tracking-widest text-white"
                >
                  view project
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-6 bg-gray-200 p-6 md:p-10">
                ...
                <div
                  onClick={() => router.push("/projects/data-management")}
                  className="inline-flex cursor-pointer bg-black px-4 py-2 text-sm font-semibold uppercase tracking-widest text-white"
                >
                  view project
                </div>
